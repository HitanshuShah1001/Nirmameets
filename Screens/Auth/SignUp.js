...
export default function SignUp() {
  ...
  return (
    <SafeAreaView style={{flex:1,backgroundColor:'black'}}>
        ...
        <TextInput style={{height:50,width:'80%',backgroundColor:'white',borderRadius:20,marginTop:30,paddingHorizontal:10}} placeholder="Field" value={Field} onChangeText={(text) => setField(text)} />
